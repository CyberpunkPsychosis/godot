...
- **素材与动画**:搜索/下载 CC0 素材库(Poly Haven、ambientCG 全自动;Kenney/Quaternius/Mixamo 手动下载后一键导入)、精灵表切帧动画、glb 模型进场景、PBR 材质应用、程序化关键帧动画 —— 详见 [docs/asset-pipeline.md](docs/asset-pipeline.md);新手从 [docs/learning-path.md](docs/learning-path.md)(完整流程 + 每个软件学什么怎么学)开始
